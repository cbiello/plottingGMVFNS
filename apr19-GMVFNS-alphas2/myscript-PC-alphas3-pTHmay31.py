...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/may31-alphas3-M-run/distributions/*.dat"))
...
#        plot_MATRIX_NNLO_31_inclusive_sumET = plot
        plot_massive = plot
        plot_PC = plot.replace("-M","-PCvia03")
#        plot_mb03 = plot.replace("may31-alphas3-M","0.30-M")
...
#        gnu.add_curve(plot_mb03,{"format" : "histogram", "label" : "m_b=0.3","line_style" : 3})
...
#            gnu.add_curve(plot_MATRIX_NNLO_30,{"format" : "histogram", "label" : "MATRIX 30","line_style" : 4})
        ...
        gnu.set_plot_properties("ymin_ratio",-1)
