...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/may20ptH-alphas3-M-run/distributions/*.dat"))
...
#        plot_MATRIX_NNLO_31_inclusive_sumET = plot
        plot_massive = plot
        plot_PC = plot.replace("-M","-PCf")
#        plot_PCg = plot.replace("-M","-PCg")
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        gnu.add_curve(plot_massive,{"format" : "histogram", "label" : "massive (α_s^3)","line_style" : 1})
        gnu.add_curve(plot_PC,{"format" : "histogram", "label" : "PC (α_s^3)","line_style" : 2})
#        gnu.add_curve(plot_PCg,{"format" : "histogram", "label" : "PC (fit g)","line_style" : 3})
...
#            gnu.add_curve(plot_MATRIX_NNLO_30,{"format" : "histogram", "label" : "MATRIX 30","line_style" : 4})
        ...
        gnu.set_plot_properties("ymin_ratio",-0.4)
        gnu.set_plot_properties("ymax_ratio",0.4)
...
#            gnu.set_plot_properties("rebin",1)
        ...
        if gnu.get_name().startswith("pt_Higgs"):
            ...
            gnu.set_plot_properties("min_x_for_rebin",80)
            gnu.set_plot_properties("rebin_above_x",1)
