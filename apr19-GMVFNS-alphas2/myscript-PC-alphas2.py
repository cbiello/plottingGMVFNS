...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/apr29-M-run/distributions/*.dat"))
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        gnu.add_curve(plot_massive,{"format" : "histogram", "label" : "massive (α_s^2)","line_style" : 1})
        gnu.add_curve(plot_PC,{"format" : "histogram", "label" : "PC (α_s^2)","line_style" : 2})
