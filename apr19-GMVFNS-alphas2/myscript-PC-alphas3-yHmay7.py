...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/may7yH-alphas3-M-run/distributions/*.dat"))
...
#        plot_MATRIX_NNLO_31_inclusive_sumET = plot
        plot_massive = plot
        plot_PC = plot.replace("may7yH-alphas3-M","0.30-M")
        plot_PCg = plot.replace("-M","-PCf")
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        gnu.add_curve(plot_massive,{"format" : "histogram", "label" : "phys (α_s^3)","line_style" : 1})
#        gnu.add_curve(plot_PC,{"format" : "histogram", "label" : "mb=0.30 (α_s^3)","line_style" : 2})
...
#            gnu.add_curve(plot_MATRIX_NNLO_30,{"format" : "histogram", "label" : "MATRIX 30","line_style" : 4})
        ...
        gnu.set_plot_properties("ymax_ratio",0.3)
