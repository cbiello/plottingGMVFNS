...
# not used    parameter_list["MATRIX_version"] = self.plot_properties.get("version","0.0.1alpha") # set it to something meaningful later
        if self.plot_properties.get("legend","right") == "right":
            parameter_list["key_x"]  = 0.97 # x-position of key 
            ...
            parameter_list["key_x"]  = 0.78 # x-position of key 
            parameter_list["key_y"]  = 0.29 # y-position of key 
        elif self.plot_properties.get("legend","right") == "down down":
            parameter_list["key_x"]  = 0.60 # x-position of key 
...
set style line 5 dt (15,2) lc rgb \"red\" lw 1
set style line 6 dt (15,2) lc rgb \"purple\" lw 1
set style line 15 dt (10,3,3,3) lc rgb \"red\" lw 0.1
...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/feb19-M_qq-run/distributions/*.dat"))
...
#        plot_MATRIX_NNLO_31_inclusive_sumET = plot
        plot_massive = plot
        plot_logs = plot.replace("M","L")
        plot_MmL = plot.replace("M","MmL")
        plot_second = plot.replace("M","second")
        
#        plot_ACOT = plot.replace("Rhorry-RV-L-ptcutH2","newAparnafullRVptcut2")
#        plot_5FS = plot.replace("rhorry-nlo5fsres","rhorry-nlo5fsnew")
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        gnu.add_curve(plot_second,{"format" : "histogram", "label" : "M-L m_b=0.42 (qqx)","line_style" : 4})
        gnu.add_curve(plot_massive,{"format" : "histogram", "label" : "massive (qqx)","line_style" : 1})
        gnu.add_curve(plot_logs,{"format" : "histogram", "label" : "logs (qqx)","line_style" : 2})
        gnu.add_curve(plot_MmL,{"format" : "histogram", "label" : "M-L (qqx)","line_style" : 3})
        
        
#        gnu.add_curve(plot_ACOT,{"format" : "histogram", "label" : "PWG (bsubg)","line_style" : 3})
#        gnu.add_curve(plot_5FS,{"format" : "histogram", "label" : "bbhint (5FS NLO)","line_style" : 4})
...
#            gnu.add_curve(plot_MATRIX_NNLO_30,{"format" : "histogram", "label" : "MATRIX 30","line_style" : 4})
        ...
        gnu.set_plot_properties("xtics",10)
        gnu.set_plot_properties("mxtics",10)
...
#            gnu.set_plot_properties("rebin",1)
        ...
        if gnu.get_name().startswith("pxsec"):
            gnu.set_plot_properties("logscale_x",True)
            gnu.set_plot_properties("category","fully-inclusive")
            gnu.set_plot_properties("xlabel","m_b [GeV]")
            gnu.set_plot_properties("ylabel","integrated")
#            gnu.set_plot_properties("ymax",1200)

        if gnu.get_name().startswith("pxsec-ptHge10"):
            gnu.set_plot_properties("logscale_x",True)
            gnu.set_plot_properties("category","p_{T,H}>10 GeV")
            gnu.set_plot_properties("xlabel","m_b [GeV]")
            gnu.set_plot_properties("ylabel","integrated")
#            gnu.set_plot_properties("ymax",1000)
            
        if gnu.get_name().startswith("pxsec-ptHge15"):
            gnu.set_plot_properties("logscale_x",True)
            gnu.set_plot_properties("category","p_{T,H}>15 GeV")
            gnu.set_plot_properties("xlabel","m_b [GeV]")
            gnu.set_plot_properties("ylabel","integrated")
#            gnu.set_plot_properties("ymax",800)
            
        if gnu.get_name().startswith("pxsec-ptHge20"):
            gnu.set_plot_properties("logscale_x",True)
            gnu.set_plot_properties("category","p_{T,H}>20 GeV")
            gnu.set_plot_properties("xlabel","m_b [GeV]")
            gnu.set_plot_properties("ylabel","integrated")
#            gnu.set_plot_properties("ymax",600)

        if gnu.get_name().startswith("y_Higgs"):
        ...
        if gnu.get_name().startswith("total"):
            gnu.set_plot_properties("xlabel","m_b [GeV]")
            gnu.set_plot_properties("ylabel","integrated")
#            gnu.set_plot_properties("ymax",700)

        if gnu.get_name().startswith("total-ptH5.000000E+00"):
            gnu.set_plot_properties("category","p_{T,H}>5 GeV")

        if gnu.get_name().startswith("total-ptH1.000000E+01"):
            gnu.set_plot_properties("category","p_{T,H}>10 GeV")

        if gnu.get_name().startswith("total-ptH2.000000E+01"):
            gnu.set_plot_properties("category","p_{T,H}>20 GeV")

        if gnu.get_name().startswith("total-ptH5.000000E+01"):
            gnu.set_plot_properties("category","p_{T,H}>50 GeV")

        if gnu.get_name().startswith("total-ptH1.000000E+02"):
            gnu.set_plot_properties("category","p_{T,H}>100 GeV")
            
        if gnu.get_name().startswith("y_Higgs-ptH5.000000E+00"):
            gnu.set_plot_properties("category","p_{T,H}>5 GeV")
            gnu.set_plot_properties("ymax",180)
            gnu.set_plot_properties("ymin_ratio",0.8)
            gnu.set_plot_properties("ymax_ratio",1.8)

        if gnu.get_name().startswith("y_Higgs-ptH1.000000E+01"):
            gnu.set_plot_properties("category","p_{T,H}>10 GeV")
            gnu.set_plot_properties("ymax",100)
            gnu.set_plot_properties("ymin_ratio",0.5)
            gnu.set_plot_properties("ymax_ratio",1.5)

        if gnu.get_name().startswith("y_Higgs-ptH2.000000E+01"):
            gnu.set_plot_properties("category","p_{T,H}>20 GeV")
            gnu.set_plot_properties("ymax",50)
            gnu.set_plot_properties("ymin_ratio",0.2)
            gnu.set_plot_properties("ymax_ratio",1.2)

        if gnu.get_name().startswith("y_Higgs-ptH5.000000E+01"):
            gnu.set_plot_properties("category","p_{T,H}>50 GeV")
            gnu.set_plot_properties("ymax",15)
            gnu.set_plot_properties("ymin_ratio",-0.1)
            gnu.set_plot_properties("ymax_ratio",0.5)

        if gnu.get_name().startswith("y_Higgs-ptH1.000000E+02"):
            gnu.set_plot_properties("category","p_{T,H}>100 GeV")
            gnu.set_plot_properties("ymax",3)

        if gnu.get_name().startswith("ptH_Higgs"):
        ...
        if gnu.get_name().startswith("ptH_Higgs-zoom"):
            gnu.set_plot_properties("xlabel","p_{T,H}")
            gnu.set_plot_properties("yunit","[fb/GeV]")
#            gnu.set_plot_properties("rebin",3)
            gnu.set_plot_properties("min_x_for_rebin",50)
            gnu.set_plot_properties("rebin_above_x",4)
            gnu.set_plot_properties("ymax_ratio",0.5)
...
#             gnu.set_plot_properties("ymax",220)
# #            gnu.set_plot_properties("legend","down center")
#             gnu.set_plot_properties("ymax_ratio",1.1)
#             gnu.set_plot_properties("ymin_ratio",0.9)
#             gnu.set_plot_properties("category","p_{T,H}>2")
            

        
# #------------------------------------------------------------------------------------
#         if gnu.get_name().startswith("pt_Higgs"):
#             gnu.set_plot_properties("xlabel","p_{T,H}")
#             gnu.set_plot_properties("yunit","[fb/GeV]")
#             gnu.set_plot_properties("xmin",0)
#             gnu.set_plot_properties("xmax",300)
#             gnu.set_plot_properties("rebin_above_x",4)
#             gnu.set_plot_properties("min_x_for_rebin",180)

#         if gnu.get_name().startswith("ptzoom_Higgs"):
#             gnu.set_plot_properties("xlabel","p_{T,H}")
#             gnu.set_plot_properties("logscale_y",False)
#             gnu.set_plot_properties("yunit","[fb/GeV]")
#             gnu.set_plot_properties("rebin",4)

#         if gnu.get_name().startswith("eta_Higgs"):
#             gnu.set_plot_properties("xlabel","{/Symbol h}_{H}")
#             gnu.set_plot_properties("logscale_y",False)
#             gnu.set_plot_properties("yunit","[fb]")
#             gnu.set_plot_properties("rebin",4)
#             gnu.set_plot_properties("ymax",90)
...
# #-------------------------------------------------------------------------------
#         if gnu.get_name().startswith("n_b_jets-IFN"):
#             gnu.set_plot_properties("xlabel","n_{b j_{IFN}}")
#             gnu.set_plot_properties("xmax",4.5)
        
#         if gnu.get_name().startswith("n_light_jets-IFN"):
#             gnu.set_plot_properties("xlabel","n_{light j_{IFN}}")
            
#         if gnu.get_name().startswith("n_b_jets-NAI"):
#             gnu.set_plot_properties("xlabel","n_{b j_{NAI}}")
#             gnu.set_plot_properties("xmax",4.5)
        
#         if gnu.get_name().startswith("n_light_jets-NAI"):
#             gnu.set_plot_properties("xlabel","n_{light j_{NAI}}")

#         if gnu.get_name().startswith("n_b_jets-EXP"):
#             gnu.set_plot_properties("xlabel","n_{b j_{EXP}}")
#             gnu.set_plot_properties("xmax",4.5)
        
#         if gnu.get_name().startswith("n_light_jets-EXP"):
#             gnu.set_plot_properties("xlabel","n_{light j_{EXP}}")
# #---------------------------------------------------------------------------------------------
...
#             gnu.set_plot_properties("xlabel","total")
#             gnu.set_plot_properties("category","2 b-j_{EXP}")

#         if gnu.get_name().startswith("total-1lightEXP"):
#             gnu.set_plot_properties("xlabel","total")
#             gnu.set_plot_properties("category","1 l-j_{EXP}")

#         if gnu.get_name().startswith("total-NAI-1bjet"):
#             gnu.set_plot_properties("xlabel","total")
#             gnu.set_plot_properties("category","1 b-j_{NAI}")
            
#         if gnu.get_name().startswith("total-NAI-2bjet"):
#             gnu.set_plot_properties("xlabel","total")
#             gnu.set_plot_properties("category","2 b-j_{NAI}")

#         if gnu.get_name().startswith("total-1lightNAI"):
#             gnu.set_plot_properties("xlabel","total")
#             gnu.set_plot_properties("category","1 l-j_{NAI}")
            
#         if gnu.get_name().startswith("total-1lightIFN"):
#             gnu.set_plot_properties("xlabel","total")
#             gnu.set_plot_properties("category","1 l-j_{IFN}")
            
#         if gnu.get_name().startswith("total-IFN-1bjet"):
#             gnu.set_plot_properties("xlabel","total")
#             gnu.set_plot_properties("category","1 b-j_{IFN}")
            
#         if gnu.get_name().startswith("total-IFN-2bjet"):
#             gnu.set_plot_properties("xlabel","total")
#             gnu.set_plot_properties("category","2 b-j_{IFN}")
...
#             gnu.set_plot_properties("xlabel","{/Symbol D}R_{H,bj_{1,EXP}}")
#             gnu.set_plot_properties("category","1 b-j_{EXP}")
#             gnu.set_plot_properties("ymax",1000)
#             gnu.set_plot_properties("legend","down center")            
...
#             gnu.set_plot_properties("xlabel","{/Symbol D}y_{H,bj_{1,EXP}}")
#             gnu.set_plot_properties("category","1 b-j_{EXP}")
#             gnu.set_plot_properties("legend","down center")
...
#            gnu.set_plot_properties("logscale_y",False)
        ...
        if gnu.get_name().startswith("total"):
            gnu.set_plot_properties("logscale_y",False)
            gnu.set_plot_properties("xtics",2)
            gnu.set_plot_properties("mxtics",10)
#            gnu.set_plot_properties("ymin_ratio",0.9)
#            gnu.set_plot_properties("ymax_ratio",1.1)
...
#        gnu.set_plot_properties("process","pp{/Symbol \256}W^+Z{/Symbol \256}e^+ e^{\342\210\222} {/Symbola μ}^+ {/Courier=30 ν}_{/Symbola μ}")
        gnu.set_plot_properties("process","b{/b b\u0305}H")
